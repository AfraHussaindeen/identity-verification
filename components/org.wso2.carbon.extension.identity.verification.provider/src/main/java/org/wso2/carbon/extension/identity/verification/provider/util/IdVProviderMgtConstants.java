...
public class IdVProviderMgtConstants {
    ...
    public static class SQLQueries {
        ...
        public static final String GET_IDVPS_SQL_BY_MSSQL_WITH_FILTER = "SELECT ID, UUID, NAME, IDVP_TYPE, DESCRIPTION, IS_ENABLED, IMAGE_URL FROM " +
                "IDVP WHERE %s TENANT_ID=? ORDER BY UUID OFFSET ? ROWS FETCH NEXT ? ROWS ONLY";
        public static final String GET_IDVPS_SQL_BY_MYSQL_WITH_FILTER = "SELECT ID, UUID, NAME, IDVP_TYPE, DESCRIPTION, IS_ENABLED, IMAGE_URL FROM " +
                "IDVP WHERE %s TENANT_ID=? ORDER BY UUID ASC LIMIT ?, ?";
        public static final String GET_IDVPS_SQL_BY_POSTGRESQL_WITH_FILTER = "SELECT ID, UUID, NAME, IDVP_TYPE, DESCRIPTION, IS_ENABLED, IMAGE_URL FROM " +
